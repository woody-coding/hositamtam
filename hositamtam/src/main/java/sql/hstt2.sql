...
insert into store values (seq_sno.nextval, 99, 'longlee', '', '', '지게골역 출구 앞 5m', '35.33242', '145.23432', '좌판', 'testphoto2.jpeg', 2, 99);
insert into store values (seq_sno.nextval, 2, 'shortlee', 1, 1, '문현역 5번 출구 앞', '35.33242', '145.23432', '매장', 'testphoto2.jpeg', 2, 99);
insert into store values (seq_sno.nextval, 2, 'longlee', 3, 1, '서면역 출구 앞 5m', '35.33242', '145.23432', '좌판', 'testphoto3.jpeg', 2, 99);
insert into store values (seq_sno.nextval, 99, 'king123', 2, 2, '지게골역 출구 앞 5m', '35.33242', '145.23432', '매장', 'testphoto2.jpeg', 2, 99);
...
--* 더미 데이터)
insert into post values (seq_pno.nextval, 100, 'king123', '2023-10-23', '와 이거 실화냐?', '진짜 좀 심하네요 너무 맛없는데 요기 왜옴?? ㄹㅇ이해안되네', 'testphoto.jpeg', 777);
