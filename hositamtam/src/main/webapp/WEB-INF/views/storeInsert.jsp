...
<body>
	...
	<header class="mainHeader">
		<div class="mainHeader__logo">
			<img class="mainHeader__logo__img" src="../images/logo.ico"
				alt="logo" />
		</div>

		<form id="searchForm" method="get" action="SearchController">
			<div class="market__search">
				<input type="text" class="market__searchInput" name="market"
					id="searchInput" placeholder="   궁금한 시장 이름을 입력하세요. Ex.부평깡통시장" />
				<button class="market__searchButton" type="submit" name="action"
					value="search">
	...
	<section id="store__update" class="section">
		<div class="max-container">
			<div class="store__update">
				<form id="store__update__form" method="GET" action="/finalProject/views/storeInsert">
					<label for="store__name" class="store__label"> 
						<input class="store__input" type="text" id="store__name" maxlength="15" placeholder="점포의 이름을 지어주세요! (최대15자)" />
					...
					<div class="store__update__form">
						<div class="store__type">
							...
							<label for="stype">
							<input type="radio" id="stype" name="stype" value="좌판"/>좌판
							<input type="radio" id="stype" name="stype" value="매장"/>매장						
							</label>
						...
						<div class="store__payment">
							...
							<label for="spayment">
							<input type="checkbox" id="spayment" name="spayment1" value="1"/>현금
							<input type="checkbox" id="spayment" name="spayment2" value="2"/>카드
							<input type="checkbox" id="spayment" name="spayment3" value="3"/>계좌이체
							</label>
							
							
							<!-- <button class="store__payment__button1" type="button">현금</button>
							<button class="store__payment__button2" type="button">카드</button>
							<button class="store__payment__button3" type="button">계좌이체</button> -->
						</div>
						<div class="store__category">
							...
							<label for="store__category__contents" class="category__label">
								<input class="category__input" type="text" id="store__category__contents" placeholder="점포의 취급품목을 알려주세요 !" />
							</label>
						</div>
						<div class="store__photo">
							<h2 class="store__photo__title siau__h2">점포 사진</h2>
							<label class="store__photo__label"> <input type="file"
								name="photo" class="store__photo__input" />
							</label>
						</div>
					</div>
					...
					<button class="store__update__button" type="submit">등록하기</button>
				</form>
			</div>
		</div>
	</section>
		...
		<div class="information__located">
			<div class="max-container">
				...
				<div class="information__contents">
					...
					<p class="information__title">
						<br /> <i class="fa-brands fa-github"></i>
